...
Or you can append the vertices and indices to existing buffers by passing in a corresponding
object containing entries for `vertices` and `indices`, e.g.:

```js
var triangles = {vertices: [], indices: []};
earcut([[[10,0],[0,50],[60,60],[70,10]]], triangles); // append to triangles obj
earcut([[[110,100],[100,150],[160,160],[170,110]]], triangles); // append to triangles obj
// triangles => {
